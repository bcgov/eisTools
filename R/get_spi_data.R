...
#' @export
#'
observations <- function(species=NULL, start_date=NULL, end_date=NULL, crs=3005){
...
#' @export
#'
telemetry <- function(species=NULL, start_date=NULL, end_date=NULL, crs=3005){
...
#' @importFrom magrittr %>%
#' @export
surveys <- function(species=NULL, region=NULL, crs=3005){
  dup <- tryCatch({
